...
export const guide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: `SeldonFrame takes the opposite approach: ${BUILDER_PRICING_CLAIM} The first workspace is free forever, cancel anytime, and there is no trial gate — the free build, claim, and use flow *is* the trial, and a custom domain for your own workspace is included. ${AGENCY_PRICING_CLAIM}

The AI receptionist that GoHighLevel charges extra for is the product here, and it's included on every tier. So are the website, CRM, booking, and reviews; the client portal for reselling under your own brand is part of Agency Starter.
...
If your business is built on high-volume funnels and complex multi-step campaigns, and you have the budget and time to master it, GoHighLevel remains a strong choice. If you mainly want an AI front office per client without a bill that grows every time you add one, [the flat-priced alternative](/guides/gohighlevel-vs-seldonframe) is the safer math.`,
  ...
  faq: [
    ...
    },
    {
      ...
      a: `Yes. ${BUILDER_PRICING_CLAIM} It includes unlimited workspaces, the first workspace free forever, no trial gate, and cancel anytime, with the AI receptionist, website, CRM, booking, reviews, and a custom domain for your own workspace all included. ${AGENCY_PRICING_CLAIM} It runs on your own AI keys and your own Twilio, so AI and telephony run at raw provider cost with no platform markup, which is how the price stays flat as you grow.`
    }
  ],
  sources: [
