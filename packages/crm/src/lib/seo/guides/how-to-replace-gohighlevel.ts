...
export const guide: Guide = {
  ...
  title: "How to Replace GoHighLevel With an AI Front Office",
  description:
  ...
  dek: "Most people run a fraction of what GoHighLevel bills them for. Replacing it starts with naming the handful of jobs you actually use, then choosing the own-business or agency tier that fits the work.",
  sections: [
    {
    ...
    },
    {
      ...
      diagram: {
        ...
        items: [
          ...
          { label: "SeldonFrame Agency Starter", value: 99, display: "$99/mo, AI included" },
        ],
  ...
  faq: [
    ...
    },
    {
      ...
      a: `It depends on your current plan and how many clients you run, so the honest answer is the shape of the bill rather than a single figure. GoHighLevel stacks a base plan, reported at 97 to 497 dollars a month, a per-location AI add-on reported at roughly 50 or 97 dollars, and rebilled usage. ${BUILDER_PRICING_CLAIM} ${AGENCY_PRICING_CLAIM} Usage runs at raw provider cost through your own keys and Twilio, so compare the tier that matches your operating model rather than assuming the Builder price covers client delivery.`,
    },
  ],
  sources: [
    {
