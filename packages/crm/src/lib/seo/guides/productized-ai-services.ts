  ...
  sections: [
    {
      ...
      body: '"Custom AI consulting" and "a productized AI package" can involve the exact same underlying work. The difference is entirely in how it\'s packaged — and that difference shows up in three places a services business actually feels.\n\n**It sells faster.** A named package with a fixed scope and a fixed price is something a prospect can say yes to on the spot. A custom engagement needs a discovery call, a proposal, and a negotiation before anyone commits to anything. Removing that scoping friction is most of what "productized" buys you commercially.\n\n**It delivers faster.** Custom work means re-deriving the approach for every client — what to build, how to configure it, what "done" looks like. A productized offer has one onboarding path you run repeatedly, so the second delivery is faster than the first, and the tenth is close to instant.\n\n**It gets more profitable with every delivery.** Custom engagements don\'t get materially cheaper to deliver as you do more of them — each one is still bespoke. A productized offer\'s delivery cost drops as the template, the checklist, and the configuration process get reused and refined.\n\nCustom AI consulting is the opposite of all three. It sells slowly, because every deal needs its own scoping call. It delivers slowly, because every build starts from a blank page. And margins stay flat or shrink as complexity creeps in, project by project.',
      callout: {
        kind: "analogy",
        text: "A *productized service* is a value-meal menu, not a made-to-order counter. Same kitchen, same ingredients — but the menu removes the back-and-forth before anyone can order.",
      },
      diagram: {
        type: "compare",
        title: "Custom consulting vs. a productized offer",
        left: {
          heading: "Custom AI consulting",
          items: [
            "Needs a discovery call before every yes",
            "Rebuilt from a blank page for each client",
            "Margins flat or shrink as complexity creeps in",
          ],
        },
        right: {
          heading: "Productized offer",
          items: [
            "Named package, fixed price — sign now",
            "Cloned from one reusable template",
            "Margins improve as delivery gets reused",
          ],
        },
      },
    },
    {
      ...
      body: "A productized offer has five parts. The exercise worth doing before you touch a build tool is writing all five down — ideally as an actual sales page, even a rough one.\n\n**A name the client repeats back to you.** Not \"AI agent implementation\" but \"The After-Hours Package\" or \"The Missed-Call Recovery System.\" Something concrete enough that a client can describe it to their business partner without your help.\n\n**A one-sentence outcome.** Not a feature list — the result. \"Every inquiry that comes in after 6pm gets answered and booked before your team opens tomorrow,\" not \"we configure a conversational AI agent with calendar integration.\"\n\n**What's included, specifically.** The agent itself, which surfaces it runs on (SMS, web chat, voice), and what the client receives on an ongoing basis — typically a usage or performance report.\n\n**What's NOT included — the scope fence.** This is the part most first-time productizers skip, and it's the one that protects the margin.\n\nExplicitly list what triggers a change order: a new integration, a second location, a custom escalation flow. Without a written fence, every client request becomes free scope creep.\n\n**The price and the onboarding week.** One number, not a range, and a stated timeline for going live. Write the sales page for this offer before you build anything — if you can't describe it in five bullet points, it isn't productized yet, it's just a project with a name.\n\nHow to price and structure this offer — flat fee, subscription, or fee-plus-usage — is covered in depth in the [pricing-models guide](/guides/ai-agency-pricing-models). This piece is about the packaging method that pricing model gets applied to.",
    },
    {
    ...
    },
    {
      ...
      body: "A defined onboarding timeline beats \"we'll get started right away\" for the same reason a fixed price beats \"let's talk about your needs.\" It's a promise the client can hold you to and plan around, instead of an open-ended wait.\n\n**Day 1** is the intake call. You run the onboarding checklist above and collect anything client-specific — hours, scripts, integration credentials.\n\n**Days 2-3** are configuration against the template. This is where the reusable base pays off, since most of the work is filling in values, not writing new logic.\n\n**Day 4** is a test pass with the business owner present, checking the agent's behavior against real scenarios before anything goes live.\n\n**Day 5** is go-live, with the first performance report scheduled on a recurring cadence from there.\n\nThe specific day count matters less than the shape: a named checkpoint on each day, an owner-in-the-loop test before launch, and a first report already on the calendar before you finish onboarding — not something you'll \"set up later.\"",
      diagram: {
        type: "flow",
        title: "The delivery week",
        steps: [
          { label: "Day 1", sub: "Intake call — checklist + client specifics" },
          { label: "Days 2-3", sub: "Configure against the template" },
          { label: "Day 4", sub: "Test pass with the owner in the room" },
          { label: "Day 5", sub: "Go-live + first report scheduled" },
        ],
      },
    },
    {
      h2: "Scaling the menu",
      body: "The temptation once the first package sells is to build a second one immediately. Resist it until the first one's delivery is boring.\n\n\"Boring\" means you can run the onboarding week without surprises, without the founder personally debugging a config issue, and without a client asking for something the scope fence didn't anticipate. A second package built before the first is boring just doubles the number of things that can go wrong at once.\n\nOnce the first offer is genuinely repeatable, the next moves are a **bundle** — two packages sold together at a discount to the sum of their parts — and an **upgrade ladder**. A client who bought the After-Hours Package becomes the natural prospect for a broader Front-Office Package six months later, once trust and results are established.\n\nThis is the same principle as the fixed scope fence, in reverse: it's the deliberate, priced path for outgrowing that fence, instead of quietly scope-creeping the original package to death.\n\nRetire a package when its delivery checklist stops being boring for a structural reason — the underlying tool it depends on changed its API, or the demand simply moved on. Don't carry a package that needs constant one-off exceptions just to keep selling it.",
      callout: {
        kind: "warning",
        text: "Building package #2 before package #1 is boring doesn't spread the risk — it doubles it. Two unproven offers can break in two different ways, in the same week.",
      },
    },
    {
  ...
  faq: [
    {
      ...
      a: "The comparison runs the other way. A pure self-serve SaaS product has to work with **zero human involvement** for every customer — a much harder bar than a productized service, where you're delivering configuration and support alongside the software. The moat in a productized service is that you operate it: the onboarding checklist, the client relationship, the judgment calls a pure software product can't make. That's real, durable differentiation a SaaS competitor can't undercut by shipping a cheaper subscription.",
    },
    {
